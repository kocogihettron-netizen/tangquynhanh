...
const CONFESSION_MESSAGE = `Tớ định giữ kín, nhưng tớ muốn thành thật với lòng mình một lần trước khi cậu đi. Tớ đã từng rung động vì cậu rất nhiều, nhiều hơn mức bạn bè. Trang web này viết lên để tạm biệt và chúc cậu sẽ luôn hạnh phúc, gặp thật nhiều may mắn ở nơi ở mới nhé!`;
...
function handleResponse(isAccepted) {
    ...
    if(isAccepted) {
        ...
        text.innerHTML = "Cảm ơn vì đã là một phần thanh xuân của tớ. Tớ sẽ luôn trân trọng cậu! ❤️";
    } else {
        text.style.color = "#ffffff";
        text.innerHTML = "Chúc hành trình mới rực rỡ. Hãy luôn tự tin và tỏa sáng nhé! ✨";
    }
}
